    ...
    async function fetchAll() {
      ...
      try {
        ...
        const [timetableRes, statsRes] = await Promise.all([
          fetch(`/api/timetables?className=${encodeURIComponent(studentClass)}`, { credentials: "include" }),
      ...
      >
        <div className={styles.headerCard}>
          <div className={styles.headerLeft}>
            ...
            <h1 className={styles.title}>{getGreeting()}, {studentName || "Student"}</h1>
            <p className={styles.subtitle}>{studentClass || "Class"} • {studentId || "ID"}</p>
          </div>
            ...
            <div className={styles.sectionTitleRow}>
              ...
              <div className={styles.sectionInfo}>
                ...
                <p style={{ fontSize: "11px", color: "#94a3b8", margin: 0 }}>
                  {getCurrentDayName()} - {studentClass}
                </p>
              </div>
            </div>
          ...
          <div className={styles.sectionContent}>
            {!todayTimetable || todayTimetable.periods.length === 0 ? (
              <div className={styles.emptyState}>
                ...
                <p className={styles.emptyText}>Timetable has not been set for your class yet.</p>
              </div>
            ) : (
