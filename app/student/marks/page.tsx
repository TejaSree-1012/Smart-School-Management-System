...
export default function StudentMarks() {
  ...
  async function fetchMarks() {
    try {
      ...
      setTermWiseSummary(data.termWiseSummary || {});
    ...
    return (
      <div className={styles.container}>
        <div className={styles.loadingContainer}>
          ...
          <p className={styles.loadingText}>Loading your marks...</p>
        </div>
      </div>
    );
  }
      ...
      <div className={styles.container}>
        <div className={styles.headerCard}>
          <div className={styles.headerLeft}>
            ...
            <p className={styles.subtitle}>View your academic performance</p>
          </div>
        </div>
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.emptyContainer}>
          ...
          <p>Your examination marks will appear here once published by your school.</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div className={styles.headerCard}>
          <div className={styles.headerLeft}>
            ...
            <h1 className={styles.title}>My Marks & Results</h1>
            <p className={styles.subtitle}>Track your academic performance and progress</p>
          </div>
