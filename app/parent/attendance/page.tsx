...
export default function ParentAttendance() {
  ...
  async function fetchAttendance() {
    ...
    try {
      setLoading(true);
      setError(null);
      const res = await fetch(`/api/parent/attendance?studentId=${encodeURIComponent(childId)}&month=${currentMonth}&year=${currentYear}`, {
        credentials: "include"
      });
  ...
  const getPercentageMessage = (percentage: number) => {
    ...
    if (percentage >= 90) return "Great Attendance!";
        ...
        >
          <div className={styles.headerCard}>
            <div className={styles.headerLeft}>
              ...
              <h1 className={styles.title}>{childName}&apos;s Attendance</h1>
              <p className={styles.subtitle}>Track attendance</p>
            </div>
          </div>
        </motion.div>
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.emptyContainer}>
          ...
          <p>Attendance records will appear here once marked.</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div className={styles.headerCard}>
          <div className={styles.headerLeft}>
            ...
            <h1 className={styles.title}>{childName}&apos;s Attendance Record</h1>
            <p className={styles.subtitle}>Track attendance • {childClass}</p>
          </div>
