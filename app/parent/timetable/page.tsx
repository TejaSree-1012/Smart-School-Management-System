...
export default function ParentTimetable() {
  ...
  async function fetchTimetables() {
    ...
    try {
      setLoading(true);
      const res = await fetch(`/api/timetables?className=${encodeURIComponent(childClass)}`, {
        credentials: "include"
      });
    ...
    >
      <div className={styles.headerCard}>
        <div className={styles.headerLeft}>
          ...
          <h1 className={styles.title}>{childName}&apos;s Timetable</h1>
          <p className={styles.subtitle}>View weekly class schedule</p>
        </div>
        ...
        <div className={styles.timetableWrapper}>
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyText}>
              Timetable for {childClass} on {DAYS.find(d => d.id === selectedDay)?.full} has not been set yet.
            </p>
          </div>
        </div>
      ) : (
          ...
          <div className={styles.timetableHeader}>
            <div className={styles.timetableInfo}>
              ...
              <div className={styles.timetableMeta}>
                <h2>{childClass} - {DAYS.find(d => d.id === currentTimetable.dayOfWeek)?.full}</h2>
